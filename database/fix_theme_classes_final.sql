-- Script per correggere definitivamente le classi tema nel database
-- Aggiorna le classi tema per essere coerenti con il CSS

-- Aggiorna Marathon
UPDATE theme_identities 
SET class_name = 'race-marathon' 
WHERE name = 'Marathon' AND class_name != 'race-marathon';

-- Aggiorna 30K Portici  
UPDATE theme_identities 
SET class_name = 'race-portici' 
WHERE name = '30K Portici' AND class_name != 'race-portici';

-- Aggiorna Run Tune Up
UPDATE theme_identities 
SET class_name = 'race-run-tune-up' 
WHERE name = 'Run Tune Up' AND class_name != 'race-run-tune-up';

-- Aggiorna 5K
UPDATE theme_identities 
SET class_name = 'race-5k' 
WHERE name = '5K' AND class_name != 'race-5k';
